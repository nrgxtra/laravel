                ...
                <div class="col-lg-4">
                    <div class="side-bar-area pr-20">
                        <div class="author-profile">
                            <img src="{% static 'images/blog/writer.jpeg' %}" alt="images">
                            <h3>{{ name }}</h3>
                            {% if bio %}
                            <p>{{ bio | truncatewords:15}}</p>
                            {% endif %}
                            <ul class="profile-social-link">
                                {% if vm %}
                                    <li>
                                        <a href="{{ vm }}" target="_blank">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="blog-card box-shadow">
                                    <a href="{% url 'post_details' post.id post.slug %}" class="img">
                                        <img src="{{ post.imageURL }}" alt="Blog" style="object-fit: cover" width="296" height="193"/>
                                    </a>
                                    <div class="content">
                                        <ul>
                                            <li>
