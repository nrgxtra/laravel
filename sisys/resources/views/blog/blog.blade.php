                ...
                <div class="col-lg-4">
                    <div class="side-bar-area pr-20">
                        <div class="search-widget">
                            <form class="search-form" name=query action="{% url 'search_blog' %}" method="get">
                                <input type="search" class="form-control" name=query placeholder="Search By Keywords">
                                <button type="submit">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="blog-card box-shadow">
                                <a href="{% url 'post_details' post.id post.slug %}" class="img">
                                    <img src="{{ post.imageURL }}" alt="Blog" style="object-fit: cover" width="250" height="250"/>
                                </a>
                                <div class="content">
                                    <ul>
                                        <li>
                        ...
                        <div class="col-lg-12 col-md-12 text-center">
                            <div class="pagination-area">
                                ...
                                {% for i in paginator %}
                                    ...
                                    {% else %}
                                        <a href="{% url 'blog_home' %}?page={{ i.number }}"
                                           class="page-numbers">{{ i.number }}</a>
                                    {% endif %}
                                {% endfor %}

                                {% if page_obj.has_next %}
                                    <a href="{% url 'blog_home' %}?page={{ page_obj.next_page_number }}"
