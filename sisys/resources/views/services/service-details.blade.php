                            ...
                            <ul class="navbar-nav m-auto">
                                   ...
                                   <a href="#" class="nav-link dropdown-toggle">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item">
                                                    <a href="pricing-1.blade.php" class="nav-link">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="customer-services.blade.php" class="nav-link">Customer Services</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="col-lg-4">
                        <div class="side-bar-area pr-20">
                            ...
                            <div class="side-bar-widget">
                                ...
                                <button class="default-btn active" type="submit"><i class="flaticon-download-pdf"></i> Download PDF Now!</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="services-details-content">
                            <div class="services-preview-img">
                                <img src="assets/images/services/services-details.jpg" alt="Services Details" />
                            </div>
                            <h2 class="title">Happy Hands Nail Polish And Exclusive Collection</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="services-preview-img">
                                        <img src="assets/images/services/services-img10.jpg" alt="Services Details" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="services-preview-img">
                                        <img src="assets/images/services/services-img15.jpg" alt="Services Details" />
                                    </div>
                                </div>
                            </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="copy-right-text text-center">
                    <p>
                        Copyright @<script>document.write(new Date().getFullYear())</script> <b>Naon</b> All Rights Reserved
